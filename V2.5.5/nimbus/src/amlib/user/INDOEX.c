...
{
  *output = (NR_TYPE)((Aerosol_blk *)input)->BCUT;
...
{
  *output = (NR_TYPE)((Aerosol_blk *)input)->BABS;
...
{
  *output = (NR_TYPE)((Aerosol_blk *)input)->BSPD;
...
{
  *output = (NR_TYPE)((Aerosol_blk *)input)->BSPW;
...
{
  *output = (NR_TYPE)((Aerosol_blk *)input)->BSPWRH;
...
{
  *output = (NR_TYPE)((Mass_blk *)input)->mass1;
