...
static PMS	pms1_probes[] =
	{
	FSSP_STR,	FSSPNAMES,	FSSP,	16,	PROBE_FSSP,	0,
	ASAS_STR,	ASASNAMES,	ASAS,	16,	PROBE_PCASP,	0,
	F300_STR,	F300NAMES,	F300,	32,	PROBE_F300,	0,
	X200_STR,	X200NAMES,	X200,	16,	PROBE_200X,	0,
	Y200_STR,	Y200NAMES,	Y200,	16,	PROBE_200Y,	0,
	X260_STR,	X260NAMES,	X260,	64,	PROBE_260X,	0,
	NULL,		NULL,		0,	0,	0,		0
	};

static PMS	pms1v2_probes[] =
	{
	FSSP_STR,	FSSPV2NAMES,	FSSP,	16,	PROBE_FSSP,	0,
	PCAS_STR,	PCASPNAMES,	ASAS,	16,	PROBE_PCASP,	0,
	F300_STR,	F300NAMES,	F300,	32,	PROBE_F300,	0,
	X200_STR,	X200NAMES,	X200,	16,	PROBE_200X,	0,
	Y200_STR,	Y200NAMES,	Y200,	16,	PROBE_200Y,	0,
	X260_STR,	X260NAMES,	X260,	64,	PROBE_260X,	0,
	MASP_STR,	NULL,		MASP,	32,	PROBE_MASP,	0,
	NULL,		NULL,		0,	0,	0,		0
	};

static PMS	pms1v3_probes[] =
	{
	SPP100_STR,	NULL,		FSSP,	0,	PROBE_FSSP,	0,
	SPP200_STR,	NULL,		ASAS,	0,	PROBE_PCASP,	0,
	SPP300_STR,	NULL,		F300,	0,	PROBE_F300,	0,
	NULL,		NULL,		0,	0,	0,		0
	};

static PMS	pms2d_probes[] =
	{
	P2D_C_STR,	TWODNAMES,	0,	0,	PROBE_2DC,	0,
	P2D_P_STR,	TWODNAMES,	0,	0,	PROBE_2DP,	0,
	P2D_G_STR,	NULL,		0,	0,	PROBE_PMS2D,	0,
//	P2D_H_STR,	NULL,		0,	0,	PROBE_PMS2D,	0,
	NULL,		NULL,		0,	0,	0,		0
	};
...
static void add_file_to_RAWTBL(), add_file_to_DERTBL(), initHDR(char vn[]),
	initSDI(char vn[]), initHoneywell(char vn[]), initOphir3(char vn[]),
	initPMS1D(char vn[]), initPMS1Dv2(char vn[]), initTans(char vn[]),
	initLitton51(char vn[]), add_derived_names(char vn[]),
	initPMS2D(char vn[], int n), initPMS2Dhouse(char vn[]),
	initGreyHouse(char vn[]), initMASP(char vn[]), initPMS1Dv3(char vn[]),
	add_raw_names(char vn[]), initRDMA(char vn[]);
...
static void initRDMA(char vn[])
{
  ...
  if ((indx = LinearSearchTable((char **)raw, nraw, "ARDMA")) == ERR)
    {
  ...
  if ((indx = LinearSearchTable((char **)derived, nderive, "CRDMA")) == ERR)
    {
