...
static NR_TYPE	find_root_by_newton(), dewpt(), vapi(), fpt(), vapor(),
		etodw(), etofp();
...
static NR_TYPE find_root_by_newton(func, initial_guess, tolerance)
NR_TYPE	(*func)();
NR_TYPE	initial_guess;
NR_TYPE	tolerance;
{
	int	cnt = 0;
