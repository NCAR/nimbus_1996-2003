...
struct _dnfn deriveftns[] =
		...
		"A2DC",		xlTwodInit,	xlTwoD,		NULL,
		"A2DP",		xlTwodInit,	xlTwoD,		NULL,
		...
		"C2DC",		sTwodInit,	NULL,		sTwoD,
		"C2DP",		sTwodInit,	NULL,		sTwoD,
		...
		"MRLHS",	NULL,		xltdlmrs,	NULL,
		"MRLHW",	NULL,		xltdlmrw,	NULL,
