...
void CreateNetCDF(char fileName[])
{
  ...
  int	ndims, dims[3], TimeDim,
	...
	Dim1000Hz, Vector16Dim, Vector32Dim, Vector64Dim, Vector10Dim,
	Vector20Dim, Vector30Dim, Vector40Dim, AsyncDim;
  ...
  AsyncDim = Vector16Dim = Vector32Dim = Vector64Dim = Vector10Dim =
  Vector20Dim = Vector30Dim = Vector40Dim = ERR;
