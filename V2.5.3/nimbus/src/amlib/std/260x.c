...
/*
printf("In 260C %2d:%2d:%2d, tasx = %f\n", (int)SampledData[timeIndex[0]], (int)SampledData[timeIndex[1]], (int)SampledData[timeIndex[2]], tasx);
for (i = 0; i < 10; ++i)
{ sv[i] = -1.0;
  printf("%6d ", (int)actual[i]);
}
printf("\n");
*/
