...
*/
#define L1 2.1 		/* length of long King probe (cm) */
#define	D1 0.21		/*  diameter of long King probe (cm) */

/* -------------------------------------------------------------------- */
NR_TYPE kinglwcc(plwc,tasx,atx,psxc,twire)
NR_TYPE	atx, plwc, tasx, psxc, twire;
{
	...
	fact = 1.0e6*0.239/(L1*D1*tasx*100.*(597.3+373.16-tk));
