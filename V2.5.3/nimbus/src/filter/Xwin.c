...
Widget	parent;
{
  ...
  XtAddCallback(b[5], XmNactivateCallback, CancelSetup, NULL);
  ...
  n = 0;
  XtSetArg(args[n], XmNlabelString, (xmstr[0]=XmStringCreateLtoR("                  Sample Output Static Spike      Cal Coes/\n  Name     Output  Rate   Rate   Lag   Slope    Dependencies", XmSTRING_DEFAULT_CHARSET))); n++;
