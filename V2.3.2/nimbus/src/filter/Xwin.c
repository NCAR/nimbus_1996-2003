...
/*	XtAddCallback(b[5], XmNactivateCallback, ToggleProbeMenu, NULL); */
	XtManageChildren(b, 6);
...
"                  Sample Output Static Spike      Cal Coes/\n  Name     Output  Rate   Rate   Lag   Slope    Dependencies",
