...
/* -------------------------------------------------------------------- */
NR_TYPE PolyInterp(yaxis, ms_gap, ms_want)
NR_TYPE	yaxis[];	/* Points from logical record	*/
int		ms_gap;		/* Create xaxis from rate		*/
int		ms_want;	/* Millisecond we want (i.e. x)	*/
{
	int		i, m;
...
/* -------------------------------------------------------------------- */
NR_TYPE LinearInterpolate(p1, p2, ms_gap, ms_want)
NR_TYPE	p1;
NR_TYPE	p2;
int		ms_gap;
int		ms_want;
