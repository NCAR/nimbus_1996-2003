...
{
	*np = (NR_TYPE)FirstPoly((float)((Oph3_blk *)p)->gain, varp->cof);
...
{
	*np = (NR_TYPE)FirstPoly((float)((Oph3_blk *)p)->det_bias, varp->cof);
...
{
	*np = (NR_TYPE)FirstPoly((float)((Oph3_blk *)p)->snout_tmp, varp->cof);
...
{
	*np = (NR_TYPE)FirstPoly((float)((Oph3_blk *)p)->bench_tmp, varp->cof);
...
{
	*np = (NR_TYPE)FirstPoly((float)((Oph3_blk *)p)->det_tmp, varp->cof);
...
{
	*np = (NR_TYPE)FirstPoly((float)((Oph3_blk *)p)->cool_tmp, varp->cof);
...
{
	*np = (NR_TYPE)FirstPoly((float)((Oph3_blk *)p)->float_tmp, varp->cof);
...
{
	*np = (NR_TYPE)FirstPoly((float)((Oph3_blk *)p)->motor_spd, varp->cof);
...
{
	*np = (NR_TYPE)FirstPoly((float)((Oph3_blk *)p)->det_sig, varp->cof);
...
{
	*np = (NR_TYPE)FirstPoly((float)((Oph3_blk *)p)->box_tmp, varp->cof);
