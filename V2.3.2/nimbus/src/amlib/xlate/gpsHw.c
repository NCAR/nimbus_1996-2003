...
static const int	transportDelay = -200;
...
void xlghutc(RAWTBL *varp, void *p, NR_TYPE *np)
{
	 ...
	 */
	x = (((HwGps_blk *)p)->utc_time & 0x7fffffff) >> 10;
	*np = x * 9.536743;
...
void xlghalt(RAWTBL *varp, void *p, NR_TYPE *np)
{
	 ...
	 */
	x = (((HwGps_blk *)p)->altitude & 0x7fffffff) >> 10;
	*np = x * 0.125;
...
void xlghhdop(RAWTBL *varp, void *p, NR_TYPE *np)
{
	 ...
	 */
	x = (((HwGps_blk *)p)->hdop & 0x7fffffff) >> 15;
	*np = x * 0.031;
...
void xlghvdop(RAWTBL *varp, void *p, NR_TYPE *np)
{
	 ...
	 */
	x = (((HwGps_blk *)p)->vdop & 0x7fffffff) >> 15;
	*np = x * 0.031;
...
void xlghlat(RAWTBL *varp, void *p, NR_TYPE *np)
{
	 ...
	 */
	x = (((HwGps_blk *)p)->latitude & 0x7fffffff) >> 10;
	*np = x * 0.000172;
...
void xlghlon(RAWTBL *varp, void *p, NR_TYPE *np)
{
	 ...
	 */
	x = (((HwGps_blk *)p)->longitude & 0x7fffffff) >> 10;
	*np = x * 0.000172;
...
void xlghgspd(RAWTBL *varp, void *p, NR_TYPE *np)
{
	 ...
	 */
	x = (((HwGps_blk *)p)->ground_speed & 0x7fffffff) >> 15;
	*np = x * 0.125 * KTS2MS;
...
void xlghvzi(RAWTBL *varp, void *p, NR_TYPE *np)
{
	 ...
	 */
	x = (((HwGps_blk *)p)->vertical_velocity & 0x7fffffff) >> 15;
	*np = x * FTMIN;
...
void xlghvew(RAWTBL *varp, void *p, NR_TYPE *np)
{
	 ...
	 */
	x = (((HwGps_blk *)p)->velocity_ew & 0x7fffffff) >> 15;
	*np = x * 0.125 * KTS2MS;
...
void xlghvns(RAWTBL *varp, void *p, NR_TYPE *np)
{
	 ...
	 */
	x = (((HwGps_blk *)p)->velocity_ns & 0x7fffffff) >> 15;
	*np = x * 0.125 * KTS2MS;
...
void xlghvfom(RAWTBL *varp, void *p, NR_TYPE *np)
{
	 ...
	 */
	x = (((HwGps_blk *)p)->vertical_fom & 0x7fffffff) >> 15;
	*np = x * 0.031;
...
void xlghhfom(RAWTBL *varp, void *p, NR_TYPE *np)
{
	 ...
	 */
	x = (((HwGps_blk *)p)->horizontal_fom & 0x7fffffff) >> 15;
	*np = x * 0.031;
