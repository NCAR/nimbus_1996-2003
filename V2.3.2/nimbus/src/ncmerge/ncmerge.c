...
char	buffer[2048];
char	VarList[MAX_IN_VARS][NAMLEN];
...
char	*argv[];
{
	...
	if (bt1 != bt2 || et1 != et2)
		{
		printf("Time segments do not match exactly, this has potential to produce inconsistant results.\n");
