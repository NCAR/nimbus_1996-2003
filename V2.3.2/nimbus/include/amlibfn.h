...
struct _dnfn deriveftns[] =
		...
		"C200X",	c200xInit,	NULL,		sc200x,
		"C200Y",	c200yInit,	NULL,		sc200y,
		"C260X",	c260xInit,	NULL,		sc260x,
		"CASAS",	casasInit,	NULL,		scasas,
		"CCEP",		NULL,		xlccep,		NULL,
		"CF300",	cf300Init,	NULL,		scf300,
		"CFSSP",	cfsspInit,	NULL,		scfssp,
		...
		"PCACTV",	NULL,		xlpms_hskp0,	NULL,
		"PCFLOW",	NULL,		xlpms_hskp6,	NULL,
		...
		"SPSFB",	NULL,		NULL,		sbit7,
		"SPSFP",	NULL,		NULL,		sbit5,
		"SPSFS",	NULL,		NULL,		sbit4,
		"SPSFT",	NULL,		NULL,		sbit6,
