...
void ophir3Init(DERTBL *varp)
{
  ...
  if ((tmp = GetDefaultsValue("A1", varp->name)) == NULL)
  {
    ...
    A1 = tmp[0];
/*  A1 = (GetDefaultsValue("A1", varp->name))[0];  <-- original code */
  ...
  if ((tmp = GetDefaultsValue("A2", varp->name)) == NULL)
  {
    ...
    A2 = tmp[0];
/*  A2 = (GetDefaultsValue("A2", varp->name))[0];  <-- original code */
  ...
  if ((tmp = GetDefaultsValue("MAXCNT", varp->name)) == NULL)
  {
    ...
    MAXCNT = tmp[0];
/*  MAXCNT = (GetDefaultsValue("MAXCNT", varp->name))[0];  <-- original code */
  ...
  if ((tmp = GetDefaultsValue("THERM_BIAS", varp->name)) == NULL)
  {
    ...
    THERM_BIAS = tmp[0];
/*  THERM_BIAS = (GetDefaultsValue("THERM_BIAS", varp->name))[0];  <-- original code */
  ...
  if ((tmp = GetDefaultsValue("THERM_RZ", varp->name)) == NULL)
  {
    ...
    THERM_RZ = tmp[0];
/*  THERM_RZ = (GetDefaultsValue("THERM_RZ", varp->name))[0];  <-- original code */
  ...
  if ((tmp = GetDefaultsValue("THERM_COEFF", varp->name)) == NULL)
  {
    ...
    THERM_COEFF = tmp[0];
/*  THERM_COEFF = (GetDefaultsValue("THERM_COEFF", varp->name))[0];  <-- original code */
  ...
  if ((tmp = GetDefaultsValue("DFLT_GAIN", varp->name)) == NULL)
  {
    ...
    DFLT_GAIN = tmp[0];
/*  DFLT_GAIN = (GetDefaultsValue("DFLT_GAIN", varp->name))[0];  <-- original code */
  ...
  if ((tmp = GetDefaultsValue("DFLT_OFFSET", varp->name)) == NULL)
  {
    ...
    DFLT_OFFSET = tmp[0];
/*  DFLT_OFFSET = (GetDefaultsValue("DFLT_OFFSET", varp->name))[0];  <-- original code */
