...
void xlilat(RAWTBL *varp, void *input, NR_TYPE *np)
{
  ...
  for (i = 0; i < varp->SampleRate; ++i)
    ...
    if (label != 0xc8)
      {
/*      if (label)
        printf("irsHw: LAT arinc label of %o\n", label);
*/
      if (i == 0)
...
void xlilon(RAWTBL *varp, void *input, NR_TYPE *np)
{
  ...
  for (i = 0; i < varp->SampleRate; ++i)
    ...
    if (label != 0xc9)
      {
/*      if (label)
        printf("irsHw: LON arinc label of %o\n", label);
*/
      if (i == 0)
...
void xlipitch(RAWTBL *varp, void *input, NR_TYPE *np)
{
  ...
  for (i = 0; i < varp->SampleRate; ++i)
    ...
    if (label != 0xd4)
      {
/*      if (label)
        printf("irsHw: PITCH arinc label of %o\n", label);
*/
      if (i == 0)
...
void xliroll(RAWTBL *varp, void *input, NR_TYPE *np)
{
  ...
  for (i = 0; i < varp->SampleRate; ++i)
    ...
    if (label != 0xd5)
      {
/*      if (label)
        printf("irsHw: ROLL arinc label of %o\n", label);
*/
      if (i == 0)
...
void xlithdg(RAWTBL *varp, void *input, NR_TYPE *np)
{
  ...
  for (i = 0; i < varp->SampleRate; ++i)
    ...
    if (label != 0xcc)
      {
/*      if (label)
        printf("irsHw: THDG arinc label of %o\n", label);
*/
      if (i == 0)
...
void xlialt(RAWTBL *varp, void *input, NR_TYPE *np)
{
  ...
  for (i = 0; i < varp->SampleRate; ++i)
    ...
    if (label != 0xf1)
      {
/*      if (label)
        printf("irsHw: ALT arinc label of %o\n", label);
*/
      if (i == 0)
...
void xlivspd(RAWTBL *varp, void *input, NR_TYPE *np)
{
  ...
  for (i = 0; i < varp->SampleRate; ++i)
    ...
    if (label != 0xf5)
      {
/*      if (label)
        printf("irsHw: VSPD arinc label of %o\n", label);
*/
      if (i == 0)
...
void xlvacc(RAWTBL *varp, void *input, NR_TYPE *np)
{
  ...
  for (i = 0; i < varp->SampleRate; ++i)
    ...
    if (label != 0xf4)
      {
/*      if (label)
        printf("irsHw: ACINS arinc label of %o\n", label);
*/
      if (i == 0)
...
void xlivew(RAWTBL *varp, void *input, NR_TYPE *np)
{
  ...
  for (i = 0; i < varp->SampleRate; ++i)
    ...
    if (label != 0xf7)
      {
/*      if (label)
        printf("irsHw: VEW arinc label of %o\n", label);
*/
      if (i == 0)
...
void xlivns(RAWTBL *varp, void *input, NR_TYPE *np)
{
  ...
  for (i = 0; i < varp->SampleRate; ++i)
    ...
    if (label != 0xf6)
      {
/*      if (label)
        printf("irsHw: VNS arinc label of %o\n", label);
*/
      if (i == 0)
...
void xligspd(RAWTBL *varp, void *input, NR_TYPE *np)
{
  ...
  for (i = 0; i < varp->SampleRate; ++i)
    ...
    if (label != 0xca)
      {
/*      if (label)
        printf("irsHw: GSPD arinc label of %o\n", label);
*/
      if (i == 0)
